...
import org.example.omi.core.fileoperation.implementation.ReadFileValue;
import org.example.omi.core.fileoperation.implementation.ReadFileZone;
...
import static org.example.omi.core.util.CollectionUtil.castListObject;
...
public final class SinkOperationImpl implements SinkOperation {
    ...
    @Override
    public List<OmiValue> readValueWithCondition(String pathValue, Predicate<? super FileObject> condition) {
     ...
     */
    private List<OmiValue> readValueWithConditionSupport(String pathValue, Predicate<? super FileObject> condition) {
        return castListObject(readFileValue.readFile(pathValue, condition).orElseGet(ArrayList::new), OmiValue.class::cast);
    }


    @Override
    public List<OmiZone> readZoneWithCondition(String pathZone, Predicate<? super FileObject> condition) {
     ...
     */
    private List<OmiZone> readZoneWithConditionSupport(String pathZone, Predicate<? super FileObject> condition) {
        return castListObject(readFileZone.readFile(pathZone,

                condition).orElseGet(ArrayList::new), OmiZone.class::cast);
    }


    @Override
    public Map<String, List<ValueAndZone>> processFilesWithConditionValue(String pathValue, String pathZone, Predicate<? super FileObject> condition) {
        System.out.println("read the next files " + pathValue + " + " + pathZone);
    ...
    @Override
    public Map<String, List<ValueAndZone>> processFilesWithConditionZone(String pathValue, String pathZone, Predicate<? super FileObject> condition) {
        Map<String, List<OmiValue>> omiValuesMap = groupingValue(castListObject(readFileValue(pathValue).orElseGet(ArrayList::new), OmiValue.class::cast));
    ...
    @Override
    public Map<String, List<ValueAndZone>> processFilesWithConditionValueAndZone(String pathValue, String pathZone, Predicate<? super FileObject> valueCondition, Predicate<? super FileObject> condition) {
