...
/**
 * The {@code ReadFileValue} class extends {@link AbstractFileReactive} and implements the {@link ReadFile} interface to provide
 ...
 * </pre>
 */
public final class ReadFileValue extends AbstractFileReactive<FileObject> implements ReadFileReactive {
     ...
     */
    @Override
    public Multi<Optional<FileObject>> readFile(String path) {
     ...
     */
    @Override
    public Multi<Optional<FileObject>> readFile(String pathValue, Predicate<FileObject> condition) {
        return readFile(pathValue, 2, condition);
    }
     ...
     */
    @Override
    protected Optional<FileObject> constructObject(String line) {
         ...
         * Cod_Tip;Descr_Tipologia;Stato;Stato_prev;Compr_min;Compr_max;Sup_NL_compr;Loc_min;Loc_max;Sup_NL_loc;
         */
        return Optional.of(createValuesFromLine(elements));
    }
