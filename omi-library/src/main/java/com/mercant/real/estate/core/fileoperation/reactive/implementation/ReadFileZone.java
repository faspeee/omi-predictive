...
/**
 * The {@code ReadFileZone} class extends {@link AbstractFileReactive} and implements the {@link ReadFile} interface to provide
 ...
 * </pre>
 */
public final class ReadFileZone extends AbstractFileReactive<FileObject> implements ReadFileReactive {
    ...
    protected Optional<FileObject> constructObject(String line) {
         ...
         * Zona;LinkZona;Cod_tip_prev;Descr_tip_prev;Stato_prev;Microzona;
         */
        return Optional.of(createZoneFromLine(elements));
    }
}
